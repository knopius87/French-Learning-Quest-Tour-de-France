...
/* Vier zusätzliche Kontextsätze pro Etappe: insgesamt sechs Lücken je Stadt. */
const clozeExpansion = {
  strasbourg: [
    { prompt: "Je viens ___ Berlin.", answers: ["de"], explain: "venir de = aus einem Ort kommen" },
    { prompt: "Vous restez ___ de temps ?", answers: ["combien"], explain: "combien de temps = wie lange" },
    { prompt: "Le quartier est très ___.", answers: ["sympa"], explain: "sympa = nett / schön" },
    { prompt: "Nous sommes en France ___ la première fois.", answers: ["pour"], explain: "pour la première fois = zum ersten Mal" }
  ],
  colmar: [
    { prompt: "Nous sommes venus ___ train.", answers: ["en"], explain: "en train = mit dem Zug" },
    { prompt: "Nous avons raté la ___.", answers: ["correspondance"], explain: "rater la correspondance = den Anschluss verpassen" },
    { prompt: "Nos ___ sont dans la voiture.", answers: ["bagages"], explain: "les bagages = das Gepäck" },
    { prompt: "Tout s’est passé sans ___.", answers: ["problème"], explain: "sans problème = ohne Probleme" }
  ],
  annecy: [
    { prompt: "Continuez tout ___.", answers: ["droit"], explain: "tout droit = geradeaus" },
    { prompt: "À quel arrêt faut-il ___ ?", answers: ["descendre"], explain: "descendre = aussteigen" },
    { prompt: "Un aller-___ pour Lyon, s’il vous plaît.", answers: ["retour"], explain: "un aller-retour = eine Hin- und Rückfahrt" },
    { prompt: "Il faut ___ le billet.", answers: ["composter"], explain: "composter le billet = die Fahrkarte entwerten" }
  ],
  lyon: [
    { prompt: "Nous avons réservé une chambre ___ deux nuits.", answers: ["pour"], explain: "pour deux nuits = für zwei Nächte" },
    { prompt: "Le petit-déjeuner est ___ ?", answers: ["compris", "inclus"], explain: "compris / inclus = inbegriffen" },
    { prompt: "La chambre est trop ___.", answers: ["bruyante"], explain: "une chambre bruyante = ein lautes Zimmer" },
    { prompt: "Nous voudrions ___ les bagages ici.", answers: ["déposer"], explain: "déposer les bagages = das Gepäck abstellen" }
  ],
  avignon: [
    { prompt: "Vous avez une table ___ terrasse ?", answers: ["en"], explain: "en terrasse = auf der Terrasse" },
    { prompt: "Et une carafe ___ eau, s’il vous plaît.", answers: ["d’", "d"], explain: "une carafe d’eau = eine Karaffe Leitungswasser" },
    { prompt: "Le steak ___, s’il vous plaît.", answers: ["saignant"], explain: "saignant = blutig / medium-rare" },
    { prompt: "Je peux régler ___ carte ?", answers: ["par"], explain: "régler par carte = mit Karte bezahlen" }
  ],
  marseille: [
    { prompt: "Vous avez quelque chose ___ la toux ?", answers: ["contre"], explain: "quelque chose contre = etwas gegen" },
    { prompt: "Je suis allergique ___ la pénicilline.", answers: ["à", "a"], explain: "être allergique à = allergisch sein gegen" },
    { prompt: "Il y a des effets ___ ?", answers: ["secondaires"], explain: "les effets secondaires = die Nebenwirkungen" },
    { prompt: "Il faut une ___ pour ce médicament.", answers: ["ordonnance"], explain: "une ordonnance = ein Rezept" }
  ],
  nice: [
    { prompt: "Le ciel est assez ___.", answers: ["couvert"], explain: "couvert = bewölkt" },
    { prompt: "Il y a beaucoup ___ vent.", answers: ["de"], explain: "beaucoup de vent = viel Wind" },
    { prompt: "On va se ___ demain.", answers: ["baigner"], explain: "se baigner = baden / schwimmen gehen" },
    { prompt: "Qu’est-ce que vous avez ___ ?", answers: ["prévu"], explain: "avoir prévu = vorhaben / geplant haben" }
  ],
  toulouse: [
    { prompt: "Je voudrais quatre tranches ___ jambon.", answers: ["de"], explain: "quatre tranches de = vier Scheiben" },
    { prompt: "Ces melons sont bien ___ ?", answers: ["mûrs"], explain: "mûr = reif" },
    { prompt: "Vous faites quelle ___ ?", answers: ["pointure"], explain: "la pointure = die Schuhgröße" },
    { prompt: "Ça fait combien ___ tout ?", answers: ["en"], explain: "en tout = insgesamt" }
  ],
  bordeaux: [
    { prompt: "Tu ___ quelle équipe ?", answers: ["supportes"], explain: "supporter une équipe = eine Mannschaft unterstützen" },
    { prompt: "L’___ au stade était incroyable.", answers: ["ambiance"], explain: "l’ambiance = die Stimmung" },
    { prompt: "Bordeaux a ___ deux à zéro.", answers: ["gagné"], explain: "gagner = gewinnen" },
    { prompt: "C’est leur meilleur ___.", answers: ["joueur"], explain: "un joueur = ein Spieler" }
  ],
  nantes: [
    { prompt: "Notre voiture est en ___.", answers: ["panne"], explain: "être en panne = eine Panne haben" },
    { prompt: "Où est le ___ le plus proche ?", answers: ["commissariat"], explain: "un commissariat = eine Polizeiwache" },
    { prompt: "Pouvez-vous appeler un ___ ?", answers: ["dépanneur"], explain: "un dépanneur = ein Pannendienst" },
    { prompt: "Il faut remplir un ___.", answers: ["constat"], explain: "un constat = ein Unfallbericht" }
  ],
  lille: [
    { prompt: "Merci ___ nous avoir invités.", answers: ["de"], explain: "merci de + Infinitiv = danke für" },
    { prompt: "Qu’est-ce qu’on peut ___ ?", answers: ["apporter"], explain: "apporter = mitbringen" },
    { prompt: "Le musée vaut vraiment le ___.", answers: ["coup"], explain: "ça vaut le coup = es lohnt sich" },
    { prompt: "Nous ___ dimanche.", answers: ["rentrons"], explain: "rentrer = heimfahren / zurückkehren" }
  ],
  paris: [
    { prompt: "Ça ___ de la météo.", answers: ["dépend"], explain: "ça dépend = es kommt darauf an" },
    { prompt: "En tout ___, merci pour votre aide.", answers: ["cas"], explain: "en tout cas = jedenfalls" },
    { prompt: "Je me ___ assez bien en français.", answers: ["débrouille"], explain: "se débrouiller = zurechtkommen" },
    { prompt: "Pourriez-vous ___ cette phrase ?", answers: ["reformuler"], explain: "reformuler = anders formulieren" }
  ]
};
...
const conversationGuides = {
  strasbourg: { choice: "Wie lange bleiben Sie?", gap: "Ich heiße Marie und komme aus Berlin.", typed: "Woher kommen Sie? Antworten Sie mit einem vollständigen Satz." },
  colmar: { choice: "Hatten Sie eine gute Reise?", gap: "Die Fahrt ist gut verlaufen.", typed: "Wie sind Sie angereist? Nennen Sie das Verkehrsmittel." },
  annecy: { choice: "Suchen Sie etwas?", gap: "Um zum See zu kommen, gehen Sie immer geradeaus.", typed: "Fragen Sie, an welcher Haltestelle Sie aussteigen müssen." },
  lyon: { choice: "Auf welchen Namen läuft die Reservierung?", gap: "Ich habe eine Reservierung auf den Namen Martin.", typed: "Fragen Sie, ob das Frühstück inbegriffen ist." },
  avignon: { choice: "Haben Sie gewählt?", gap: "Für mich gibt es Fisch mit Gemüse.", typed: "Bestellen Sie ein vegetarisches Gericht und eine Karaffe Wasser." },
  marseille: { choice: "Seit wann haben Sie Schmerzen?", gap: "Ich habe seit gestern Halsschmerzen.", typed: "Beschreiben Sie Kopfschmerzen seit gestern." },
  nice: { choice: "Was werden Sie morgen machen?", gap: "Wenn das Wetter schön ist, gehen wir baden.", typed: "Was werden Sie bei schönem Wetter tun? Nennen Sie einen Plan." },
  toulouse: { choice: "Wie viel brauchen Sie davon?", gap: "Ich hätte gern fünfhundert Gramm Käse.", typed: "Fragen Sie, ob Sie die Jacke in Größe M anprobieren können." },
  bordeaux: { choice: "Welche Mannschaft unterstützt du?", gap: "Sie haben zwei zu eins gewonnen.", typed: "Was hielten Sie vom Spiel? Formulieren Sie Ihre Meinung." },
  nantes: { choice: "Was ist passiert?", gap: "Mir wurde mein Telefon gestohlen.", typed: "Bitten Sie darum, die Polizei zu rufen." },
  lille: { choice: "Möchten Sie bei uns zu Abend essen?", gap: "Danke, sehr gern!", typed: "Bedanken Sie sich für einen schönen Abend." },
  paris: { choice: "Haben Sie verstanden?", gap: "Wenn ich richtig verstanden habe, muss ich in Lyon umsteigen.", typed: "Bitten Sie darum, langsamer zu wiederholen." }
};

Object.keys(conversationModules).forEach(function (id) {
  const guide = conversationGuides[id];
  if (!guide) return;
  conversationModules[id].choice.promptDe = guide.choice;
  conversationModules[id].gap.promptDe = guide.gap;
  conversationModules[id].typed.promptDe = guide.typed;
});
...
/* Zwei weitere Reisesituationen pro Stadt: drei Dialoge mit je drei Runden. */
const conversationExpansion = {
  strasbourg: [
    dialogueSet(
      "« C’est votre première visite à Strasbourg ? »", "Sind Sie zum ersten Mal in Strasbourg?",
      ["Oui, nous sommes ici pour la première fois.", "Non, l’addition, s’il vous plaît.", "Il faut composter le billet.", "J’ai mal à la gorge."],
      "Nous sommes ici ___ les vacances.", "Wir sind für die Ferien hier.", ["pour"], "pour les vacances = für die Ferien",
      "Présentez-vous avec votre nom, votre origine et la durée du séjour.", "Stellen Sie sich mit Name, Herkunft und Aufenthaltsdauer vor.",
      "Je m’appelle Mia, je viens d’Allemagne et je reste cinq jours.", [["je mappelle"], ["je viens de"], ["jours", "semaine"]], "Verbinde Name, Herkunft und Dauer."
    ),
    dialogueSet(
      "« Vous connaissez bien le quartier ? »", "Kennen Sie das Viertel gut?",
      ["Pas encore. Vous pouvez me recommander un café ?", "Oui, deux comprimés.", "Non, le train est en retard.", "Une chambre double, merci."],
      "Le quartier est très ___.", "Das Viertel ist sehr nett.", ["sympa"], "sympa = nett / schön",
      "Demandez poliment une recommandation pour un café.", "Bitten Sie höflich um eine Café-Empfehlung.",
      "Pourriez-vous me recommander un café sympa, s’il vous plaît ?", [["recommander"], ["cafe"], ["sil vous plait"]], "Nutze recommander und eine höfliche Bitte."
    )
  ],
  colmar: [
    dialogueSet(
      "« Comment s’est passé le trajet ? »", "Wie war die Fahrt?",
      ["Bien, mais la route était très chargée.", "Une table pour deux, merci.", "Il fera beau demain.", "Je voudrais une pommade."],
      "On a mis six heures ___ venir.", "Wir haben sechs Stunden für die Anreise gebraucht.", ["pour"], "mettre du temps pour venir = Zeit für die Anreise brauchen",
      "Expliquez que vous êtes venus en voiture et que vous avez eu du retard.", "Erklären Sie, dass Sie mit dem Auto kamen und Verspätung hatten.",
      "Nous sommes venus en voiture et nous avons eu un peu de retard.", [["sommes venus", "sommes venues"], ["en voiture"], ["retard"]], "Nenne Verkehrsmittel und Verspätung."
    ),
    dialogueSet(
      "« Votre train part de quel quai ? »", "Von welchem Bahnsteig fährt Ihr Zug ab?",
      ["Il part du quai numéro six.", "Il coûte vingt euros.", "Il est saignant.", "Il faut une ordonnance."],
      "Nous avons failli ___ le train.", "Wir hätten beinahe den Zug verpasst.", ["rater"], "faillir rater = beinahe verpassen",
      "Dites que vous avez raté la correspondance, mais que vous avez vos bagages.", "Sagen Sie, dass Sie den Anschluss verpasst haben, Ihr Gepäck aber bei sich haben.",
      "Nous avons raté la correspondance, mais nos bagages sont avec nous.", [["rate la correspondance"], ["bagages"], ["avec nous"]], "Verbinde das Reiseproblem mit einer Entwarnung."
    )
  ],
  annecy: [
    dialogueSet(
      "« C’est loin d’ici à pied ? »", "Ist es von hier zu Fuß weit?",
      ["Non, c’est à dix minutes à pied.", "Oui, la chambre est comprise.", "Non, depuis hier.", "Deux cents grammes, merci."],
      "Traversez la place et tournez ___ droite.", "Überqueren Sie den Platz und biegen Sie rechts ab.", ["à", "a"], "tourner à droite = rechts abbiegen",
      "Achetez poliment un aller-retour pour Lyon.", "Kaufen Sie höflich eine Hin- und Rückfahrt nach Lyon.",
      "Je voudrais un aller-retour pour Lyon, s’il vous plaît.", [["aller retour"], ["lyon"], ["sil vous plait"]], "Nenne Ticketart und Ziel."
    ),
    dialogueSet(
      "« Vous descendez où ? »", "Wo steigen Sie aus?",
      ["Je descends au troisième arrêt.", "Je reste trois nuits.", "Je prends le plat du jour.", "Je suis allergique."],
      "Il faut ___ à Chambéry.", "Man muss in Chambéry umsteigen.", ["changer"], "changer = umsteigen / wechseln",
      "Demandez de répéter l’itinéraire plus lentement.", "Bitten Sie darum, die Wegbeschreibung langsamer zu wiederholen.",
      "Pourriez-vous répéter l’itinéraire plus lentement, s’il vous plaît ?", [["repeter"], ["itineraire"], ["lentement", "moins vite"]], "Bitte höflich um eine langsamere Wiederholung."
    )
  ],
  lyon: [
    dialogueSet(
      "« Vous avez une réservation ? »", "Haben Sie eine Reservierung?",
      ["Oui, au nom de Schneider.", "Oui, il va pleuvoir.", "Non, un kilo de pommes.", "Au prochain carrefour."],
      "Le petit-déjeuner est ___ ?", "Ist das Frühstück inbegriffen?", ["compris", "inclus"], "compris / inclus = inbegriffen",
      "Demandez une chambre calme côté cour.", "Bitten Sie um ein ruhiges Zimmer zum Innenhof.",
      "Serait-il possible d’avoir une chambre calme côté cour ?", [["chambre"], ["calme"], ["cote cour"]], "Nenne Zimmer, Ruhe und Lage."
    ),
    dialogueSet(
      "« À quelle heure faut-il libérer la chambre ? »", "Um wie viel Uhr muss das Zimmer geräumt werden?",
      ["Avant onze heures.", "Pendant deux jours.", "Au quai numéro six.", "Avec une carafe d’eau."],
      "La climatisation ne ___ pas.", "Die Klimaanlage funktioniert nicht.", ["marche", "fonctionne"], "ne marche pas = funktioniert nicht",
      "Signalez que la chambre est bruyante et demandez-en une autre.", "Melden Sie, dass das Zimmer laut ist, und bitten Sie um ein anderes.",
      "La chambre est très bruyante. Auriez-vous une autre chambre plus calme ?", [["chambre"], ["bruyante", "bruyant"], ["autre", "plus calme"]], "Melde das Problem und formuliere eine Lösung."
    )
  ],
  avignon: [
    dialogueSet(
      "« Qu’est-ce que vous recommandez ? »", "Was empfehlen Sie?",
      ["Je vous recommande le poisson du jour.", "Descendez au troisième arrêt.", "Prenez deux comprimés.", "Le train a du retard."],
      "La salade sans ___, si possible.", "Den Salat möglichst ohne Zwiebeln.", ["oignons"], "sans oignons = ohne Zwiebeln",
      "Commandez un plat végétarien et une carafe d’eau.", "Bestellen Sie ein vegetarisches Gericht und eine Karaffe Wasser.",
      "Je voudrais un plat végétarien et une carafe d’eau, s’il vous plaît.", [["plat vegetarien"], ["carafe deau"], ["sil vous plait"]], "Beide Wünsche gehören in eine Bestellung."
    ),
    dialogueSet(
      "« Quelle cuisson pour le steak ? »", "Welche Garstufe für das Steak?",
      ["Saignant, s’il vous plaît.", "Côté cour, s’il vous plaît.", "Depuis deux jours.", "Un aller-retour."],
      "On peut avoir l’___ ?", "Können wir die Rechnung bekommen?", ["addition"], "l’addition = die Rechnung",
      "Demandez si le plat contient des noix et si vous pouvez payer séparément.", "Fragen Sie nach Nüssen und getrennter Bezahlung.",
      "Est-ce que ce plat contient des noix ? Et peut-on payer séparément ?", [["contient"], ["noix"], ["payer separement"]], "Formuliere beide Fragen nacheinander."
    )
  ],
  marseille: [
    dialogueSet(
      "« Quels sont vos symptômes ? »", "Welche Beschwerden haben Sie?",
      ["J’ai mal à la gorge et je tousse.", "Je voudrais une chambre calme.", "Le score était deux à un.", "Je cherche le quai six."],
      "Je tousse ___ deux jours.", "Ich huste seit zwei Tagen.", ["depuis"], "depuis deux jours = seit zwei Tagen",
      "Demandez la posologie et les effets secondaires.", "Fragen Sie nach Dosierung und Nebenwirkungen.",
      "Combien de fois par jour faut-il le prendre ? Y a-t-il des effets secondaires ?", [["combien de fois", "posologie"], ["par jour"], ["effets secondaires"]], "Frage nach Einnahmehäufigkeit und Nebenwirkungen."
    ),
    dialogueSet(
      "« Vous êtes allergique à quelque chose ? »", "Sind Sie gegen etwas allergisch?",
      ["Oui, je suis allergique à la pénicilline.", "Oui, je supporte Bordeaux.", "Non, à dix minutes à pied.", "Une entrée à partager."],
      "Y a-t-il une version sans ___ ?", "Gibt es eine rezeptfreie Variante?", ["ordonnance"], "sans ordonnance = rezeptfrei",
      "Décrivez un mal de tête et de la fièvre, puis demandez un remède.", "Beschreiben Sie Kopfschmerzen und Fieber und fragen Sie nach einem Mittel.",
      "J’ai mal à la tête et un peu de fièvre. Vous avez quelque chose contre ça ?", [["mal a la tete"], ["fievre"], ["quelque chose"]], "Nenne beide Beschwerden und bitte um Hilfe."
    )
  ],
  nice: [
    dialogueSet(
      "« Quel temps fera-t-il demain ? »", "Wie wird das Wetter morgen?",
      ["Il y aura du soleil avec quelques averses.", "Le train part du quai quatre.", "La réservation est à mon nom.", "Je voudrais porter plainte."],
      "Tu as regardé la ___ ?", "Hast du den Wetterbericht angesehen?", ["météo"], "la météo = der Wetterbericht",
      "Reliez le beau temps à un projet pour demain.", "Verbinden Sie schönes Wetter mit einem Plan für morgen.",
      "S’il fait beau, nous allons visiter la vieille ville demain.", [["sil fait beau"], ["allons", "on va"], ["visiter", "plage", "baigner"]], "Verbinde Wetterbedingung und Aktivität."
    ),
    dialogueSet(
      "« Vous préférez vous asseoir où ? »", "Wo möchten Sie lieber sitzen?",
      ["À l’ombre, s’il vous plaît.", "Au nom de Martin.", "Au prochain arrêt.", "Deux fois par jour."],
      "Le ciel devient ___.", "Der Himmel wird gewittrig.", ["orageux"], "orageux = gewittrig",
      "Proposez un musée s’il pleut.", "Schlagen Sie ein Museum vor, falls es regnet.",
      "S’il pleut, on pourrait plutôt visiter le musée.", [["sil pleut"], ["visiter"], ["musee"]], "Nutze eine Bedingung und einen Alternativplan."
    )
  ],
  toulouse: [
    dialogueSet(
      "« Combien de fromage voulez-vous ? »", "Wie viel Käse möchten Sie?",
      ["Deux cents grammes, s’il vous plaît.", "À la troisième station.", "Depuis ce matin.", "Une chambre double."],
      "Est-ce que je peux ___ ?", "Kann ich probieren?", ["goûter"], "goûter = probieren",
      "Demandez si vous pouvez essayer la veste en taille M.", "Fragen Sie, ob Sie die Jacke in Größe M anprobieren können.",
      "Est-ce que je peux essayer cette veste en taille M ?", [["essayer"], ["veste"], ["taille m"]], "Nenne Kleidungsstück und Größe."
    ),
    dialogueSet(
      "« Vous réglez comment ? »", "Wie bezahlen Sie?",
      ["Je vais régler par carte.", "Je descends ici.", "Il fait couvert.", "J’ai une ordonnance."],
      "C’est un peu trop ___.", "Das ist etwas zu teuer.", ["cher"], "trop cher = zu teuer",
      "Commandez quatre tranches de jambon et demandez le total.", "Bestellen Sie vier Scheiben Schinken und fragen Sie nach dem Gesamtpreis.",
      "Je voudrais quatre tranches de jambon. Ça fait combien en tout ?", [["quatre tranches"], ["jambon"], ["combien en tout"]], "Nenne Menge, Ware und Preisfrage."
    )
  ],
  bordeaux: [
    dialogueSet(
      "« Tu as vu le match hier ? »", "Hast du gestern das Spiel gesehen?",
      ["Oui, l’ambiance au stade était incroyable.", "Oui, une carafe d’eau.", "Non, au nom de Martin.", "Oui, depuis hier."],
      "Ils ont ___ à la dernière minute.", "Sie glichen in der letzten Minute aus.", ["égalisé"], "égaliser = ausgleichen",
      "Dites que l’équipe méritait de gagner.", "Sagen Sie, dass die Mannschaft den Sieg verdient hatte.",
      "À mon avis, l’équipe méritait de gagner.", [["a mon avis", "je pense"], ["equipe"], ["meritait de gagner"]], "Formuliere eine begründete Meinung."
    ),
    dialogueSet(
      "« Quel était le score final ? »", "Wie lautete der Endstand?",
      ["Deux à deux, ils ont fait match nul.", "Cinq cents grammes.", "Une nuitée.", "Au prochain carrefour."],
      "L’___ a arrêté le jeu.", "Der Schiedsrichter unterbrach das Spiel.", ["arbitre"], "l’arbitre = der Schiedsrichter",
      "Dites que vous n’êtes pas expert, mais que vous aimez l’ambiance.", "Sagen Sie, dass Sie kein Experte sind, aber die Stimmung mögen.",
      "Je ne suis pas expert, mais j’aime beaucoup l’ambiance.", [["ne suis pas expert"], ["aime"], ["ambiance"]], "Verbinde Einschränkung und persönliche Vorliebe."
    )
  ],
  nantes: [
    dialogueSet(
      "« Qu’est-ce qu’on vous a volé ? »", "Was wurde Ihnen gestohlen?",
      ["On m’a volé mon téléphone.", "J’ai pris le plat du jour.", "Il fera doux demain.", "Je supporte Lille."],
      "Je voudrais porter ___.", "Ich möchte Anzeige erstatten.", ["plainte"], "porter plainte = Anzeige erstatten",
      "Dites que votre portefeuille a été volé et demandez le commissariat.", "Sagen Sie, dass Ihr Portemonnaie gestohlen wurde, und fragen Sie nach der Polizeiwache.",
      "On m’a volé mon portefeuille. Où est le commissariat le plus proche ?", [["vole mon portefeuille"], ["ou"], ["commissariat"]], "Melde den Verlust und frage nach Hilfe."
    ),
    dialogueSet(
      "« Est-ce que quelqu’un est blessé ? »", "Ist jemand verletzt?",
      ["Non, mais la voiture ne roule plus.", "Non, le musée est fermé.", "Oui, avec plaisir.", "Deux cafés, merci."],
      "Je dois appeler mon ___.", "Ich muss meine Versicherung anrufen.", ["assurance"], "une assurance = eine Versicherung",
      "Expliquez la panne et demandez une dépanneuse.", "Erklären Sie die Panne und bitten Sie um einen Abschleppwagen.",
      "Notre voiture est en panne près de Nantes. Pouvez-vous appeler une dépanneuse ?", [["voiture est en panne"], ["pres de nantes"], ["appeler"], ["depanneuse", "depanneur"]], "Nenne Ort, Problem und benötigte Hilfe."
    )
  ],
  lille: [
    dialogueSet(
      "« Vous voulez venir à l’exposition avec nous ? »", "Möchten Sie mit uns zur Ausstellung kommen?",
      ["Oui, avec plaisir !", "Non, une taille plus grande.", "Oui, le train est en retard.", "Deux fois par jour."],
      "Qu’est-ce qu’on peut ___ ?", "Was können wir mitbringen?", ["apporter"], "apporter = mitbringen",
      "Acceptez l’invitation à dîner et demandez quoi apporter.", "Nehmen Sie die Einladung zum Essen an und fragen Sie, was Sie mitbringen können.",
      "Merci, avec plaisir ! Qu’est-ce qu’on peut apporter ?", [["merci"], ["avec plaisir"], ["apporter"]], "Nimm an und stelle eine praktische Rückfrage."
    ),
    dialogueSet(
      "« Vous rentrez quand ? »", "Wann fahren Sie zurück?",
      ["Nous rentrons dimanche matin.", "Nous prenons le plat du jour.", "Au quai numéro deux.", "Il faut une ordonnance."],
      "On garde ___, d’accord ?", "Wir bleiben in Kontakt, ja?", ["contact"], "garder contact = in Kontakt bleiben",
      "Remerciez pour la soirée et dites que vous espérez vous revoir.", "Bedanken Sie sich für den Abend und hoffen Sie auf ein Wiedersehen.",
      "Merci pour cette excellente soirée. J’espère qu’on se reverra bientôt.", [["merci"], ["soiree"], ["se reverra", "revoir"]], "Verbinde Dank und Abschiedswunsch."
    )
  ],
  paris: [
    dialogueSet(
      "« Vous avez tout compris ? »", "Haben Sie alles verstanden?",
      ["J’ai compris l’idée générale, mais pas tous les détails.", "Oui, le steak saignant.", "Non, la route était chargée.", "Oui, une pommade."],
      "Merci de parler moins ___.", "Danke, dass Sie langsamer sprechen.", ["vite"], "parler moins vite = langsamer sprechen",
      "Demandez un exemple ou une reformulation.", "Bitten Sie um ein Beispiel oder eine andere Formulierung.",
      "Pourriez-vous reformuler et me donner un exemple, s’il vous plaît ?", [["reformuler"], ["donner", "donnez"], ["exemple"]], "Bitte um zwei konkrete Verständnishilfen."
    ),
    dialogueSet(
      "« Vous parlez bien français ? »", "Sprechen Sie gut Französisch?",
      ["Je me débrouille, mais j’hésite parfois.", "Je voudrais régler par carte.", "Descendez au troisième arrêt.", "Il y aura des averses."],
      "Ce n’est pas grave de faire une ___.", "Es ist nicht schlimm, einen Fehler zu machen.", ["erreur"], "faire une erreur = einen Fehler machen",
      "Expliquez un mot inconnu avec une périphrase.", "Umschreiben Sie ein unbekanntes Wort.",
      "Je ne connais pas le mot, mais c’est quelque chose qui sert à voyager.", [["ne connais pas le mot"], ["quelque chose qui"]], "Nutze eine Umschreibung, statt das Gespräch abzubrechen."
    )
  ]
};
...
function moduleCard(module, index) {
  ...
  return '<button class="module-card ' + (!unlocked ? "locked" : "") + '" data-module="' + module.id + '">' +
    ...
    '<p>' + escapeHtml(module.summary) + '</p><span class="module-meta">' + (complete ? "✓ Geschafft" : unlocked ? module.vocab.length + " Wörter · " + module.cloze.length + " Lücken · " + module.conversations.length + " Dialoge" : "🔒 Noch gesperrt") + '</span></button>';
}
...
function renderLearn() {
  ...
  return '<h1 class="page-title">Reisethemen</h1><p class="page-lead">Jede Stadt führt durch zwei Vokabeletappen, Satzgerüste, sechs Lückensätze und drei Dialogszenarien. Im Vertiefungssprint wird anschließend jedes Lernwort aktiv abgefragt.</p>' +
...
function renderPractice() {
  ...
  return '<h1 class="page-title">Freies Training</h1><p class="page-lead">Übe jederzeit und ohne Einfluss auf deine aktuelle Etappe. Fehler kosten hier keine Herzen.</p>' +
    ...
    '<div class="practice-modes">' +
      '<button class="practice-mode vocab-mode" data-practice-mode="vocab"><span>' + uiIcon("chat", "mode-icon") + '</span><small>WORTSCHATZ</small><strong>Vokabel-Mix</strong><p>Erkennen, erinnern und selbst auf Französisch schreiben.</p><em>' + vocabCount + ' Wörter · bis zu 24 pro Mix</em></button>' +
      '<button class="practice-mode gap-mode" data-practice-mode="gap"><span>' + uiIcon("pen", "mode-icon") + '</span><small>LÜCKEN</small><strong>Tour-Lückensprint</strong><p>Ergänze französische Wörter im Reisekontext.</p><em>' + gapCount + ' Sätze · dreifacher Umfang</em></button>' +
...
function renderTravelLesson(module) {
  ...
  if (lessonTab === "scaffolds") {
    ...
    content += '<section class="dialogue-panel ' + (dialogueDone ? "completed" : "") + '"><span class="dialogue-icon">' + uiIcon("chat", "dialogue-svg") + '</span><div><small>CONVERSATION CHALLENGE</small><strong>' + (dialogueDone ? "3 Dialogues geschafft" : "Drei Situationen, drei Schwierigkeitsstufen") + '</strong><p>3 Szenarien · jeweils Multiple Choice → Lücke → freie Antwort</p></div><b>' + (dialogueDone ? "✓" : "9") + '</b></section>';
  } else {
  ...
  const nextLabel = lessonTab === "vocab-a" ? "Mini-Étape 2 · L’Échappée" : lessonTab === "vocab-b" ? "Mini-Étape 3 · Le Peloton" : dialogueDone ? "Vertiefungssprint starten · kompletter Wortschatz" : "3 Conversation Challenges starten · bis zu 100 XP";
  return '<div class="detail-head"><button class="back-btn" data-action="back">←</button><div><span class="stage-pill">Etappe ' + (travelModules.indexOf(module) + 1) + ' · ' + module.city + '</span><h1><span class="title-stage-icon">' + stageIcon(module, "stage-svg") + '</span>' + escapeHtml(module.title) + '</h1><p>' + escapeHtml(module.summary) + '</p></div></div>' +
    '<div class="lesson-total"><span>' + uiIcon("bike", "micro-icon") + ' 3 Mini-Étapes + 3 Dialoge</span><span>' + uiIcon("chat", "micro-icon") + ' ' + module.vocab.length + ' Wörter</span><span>' + uiIcon("puzzle", "micro-icon") + ' ' + module.cloze.length + ' Lückensätze</span></div>' +
  ...
  return conversations.reduce(function (all, conversation, scenarioIndex) {
    ...
    return all.concat([
      ...
      },
      {
        ...
        hint: scenario + " · Runde 2 · Ergänze das fehlende französische Wort.",
...
function renderComplete() {
  ...
  const heading = isParis ? "Paris erreicht!" : isDialogue ? "Dialogserie geschafft!" : isPractice ? "Training geschafft!" : quiz.perfect ? "Fantastique!" : "Etappe geschafft!";
  const description = isParis
    ? "Du hast deine Tour de France durch die Sprache vollendet. Jetzt heißt es: rausgehen und sprechen!"
    : isDialogue
      ? "Du hast drei Reisesituationen jeweils erkannt, ergänzt und vollständig selbst formuliert. Der Vertiefungssprint ist jetzt frei."
      : isPractice
